...
- 自动文档化：AI 生成经历标题、能力标签、STAR 经历稿、简历 Bullet 和待补充信息。
- AI 仪表盘：AI 生成经历成熟度、岗位匹配、行动清晰度三个评分。
- 情感陪伴：AI 识别焦虑、迷茫、自我否定，先共情，再给可执行小动作，支持重新生成。
- 发展建议：AI 根据经历信号推荐技术研发、产品策划、数据分析、游戏策划、运营、体验设计等方向，支持重新生成。
